# Average of N numbers using Scatter and Reduce

### Question

Develop a MPI program to compute the average of numbers using the MPI_Scatter and MPI_Reduce functions and compute the time required for the same. [Solution File](./solution.c)
