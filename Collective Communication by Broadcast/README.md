# Collective Communication by Broadcast

### Question

Develop a MPI program to compare the effectiveness of MPI_Bcast() with MPI_Send() and MPI_Recv(). Perform any collective communication operations (of your choice) using the above mentioned functions and print the time taken in both the approaches. [Solution File](./solution.c)
