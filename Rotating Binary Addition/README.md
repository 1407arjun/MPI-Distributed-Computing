# Rotating Binary Addition

### Question

A communicator has 3 process (ID: 0, 1 and 2) such that process 0 sends a binary value 001 to process 1, in-turn process 1 increment the value by 1 (i.e. 010) and send the same to process 2, in-turn process 2 increment the value by 1 (i.e. 011) and sent the same to process 0. Continue the process until the binary value becomes 111. Develop a MPI program to implement the above scenario. [Solution File](./solution.c)
